...
def get_result_openai(question, knowledge=None):
    ...
    completion = client.chat.completions.create(
        ...
        messages=[
            {"role": "system", "content": f"You are a helpful assistant.You will give answers to questions based on the facts and knowledge{knowledge} given and your own knowledge."},
